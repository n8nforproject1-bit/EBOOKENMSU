// =======================================================
// ⚙️ CONFIGURATION: ตั้งค่าระบบฐานข้อมูลและสิทธิ์
// =======================================================
const CONFIG = {
  // 1. ID ของ Google Sheet เล่มจริงของคุณ
  //    เปิดสเปรดชีต แล้วคัดลอกส่วน ID จาก URL:
  ...
  // 4. รหัสโฟลเดอร์ รูปหน้าปก (สำรองไว้ใช้ในอนาคต หากต้องการอัปโหลดปกแยกจากตัว PDF)
  COVER_FOLDER_ID: "1HHgEN7iE3xeRMW-LulkT-17qjYG95XI3",

  // 5. รหัสผ่านสำหรับเข้าสู่ระบบแอดมิน
  //    ⚠️ ควรเปลี่ยนเป็นรหัสที่คาดเดายากก่อนใช้งานจริง
  ADMIN_PASSWORD: "1234",

  // 6. โทเค็น Telegram Bot (ถ้าต้องการใช้งานส่งแจ้งเตือนในอนาคต)
  TELEGRAM_BOT_TOKEN: "YOUR_TELEGRAM_BOT_TOKEN_HERE"
};

/**
 * ฟังก์ชันดึงแท็บชีตฐานข้อมูลแบบปลอดภัย (Safe Database Connection)
 * ใช้ CONFIG.SPREADSHEET_ID เสมอ ทำให้ทำงานได้ทั้งกรณีสคริปต์ผูกกับสเปรดชีตโดยตรง (bound script)
 * และกรณีสคริปต์แบบเดี่ยว (standalone script) ที่ deploy แยกจากสเปรดชีต
...
function getDatabaseSheet() {
  try {
    ...
    throw new Error("ไม่สามารถเปิดใช้งาน Google Sheet ได้ กรุณาเช็คการตั้งค่าสิทธิ์แชร์ไฟล์ หรือตรวจเช็ค SPREADSHEET_ID ใน Config.gs");
  }
}
